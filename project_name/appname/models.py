...
class AllFieldType(models.Model):
    ...
    char_field = models.CharField(max_length=255)  # Example: char_field='example tex49i523i52t *=445454===========454305i405i20502'
    ...
    date_time_field = models.DateTimeField()  # Example: date_time_field='2022-06-01T12:00:00' * auto_field=True
